...
(function() {
  ...
  CelestialBodyForm = (function() {
    ...
    CelestialBodyForm.prototype.save = function() {
      var argumentOfPeriapsis, body, eccentricity, inclination, k, longitudeOfAscendingNode, mass, meanAnomalyAtEpoch, name, newBody, orbit, originalBody, originalDestination, originalName, originalOrigin, radius, ref, referenceBody, semiMajorAxis, timeOfPeriapsisPassage;
